...
export default function PlayerSelect({ host }) {
  ...
  const PlayerData = () => {
    return (
      <>
        ...
        <div className='flex flex-col gap-y-4 w-full overflow-y-scroll no-scrollbar overflow-x-hidden bg-[#00000038] border-2 p-8 border-[#ecce24b4]'>
  ...
  return (
    <>
      ...
      <div className='tracking-[.125rem] flex flex-col w-2/3 h-[90vh]'>
